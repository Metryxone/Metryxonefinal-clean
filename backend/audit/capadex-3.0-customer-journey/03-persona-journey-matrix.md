...
|---|---|---|---|---|---|---|
| Student → Career (`student_career`) | Student (school/college) | P1, P2, P3 | T1 | PARTIAL | 6/8 | 8/8 |
| Fresher → Placement (`fresher_placement`) | Fresher / final-year (job-seeker) | P4, P3 | T2 | SUPPORTED | 6/8 | 8/8 |
| Professional → Progression (`professional_progression`) | Working professional | P5 | T1 | PARTIAL | 6/8 | 8/8 |
| Employee → Competency / EI (`employee_competency`) | Enterprise employee | P5, P6 | T1 | SUPPORTED | 5/8 | 8/8 |
| HR / Recruiter → Hire (`recruiter_hire`) | HR / recruiter | P7 | T3 | SUPPORTED | 6/8 | 8/8 |
| Employer Org → Talent (`employer_talent`) | Employer organisation | P8 | T3 | SUPPORTED | 4/8 | 8/8 |
| Institute Admin → Cohort (`institute_cohort`) | Institution administrator | P9, aggregate | T4 | SUPPORTED | 4/8 | 8/8 |
