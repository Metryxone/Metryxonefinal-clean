...
| Journey | Status | Lifecycle stages (CAP_*) |
|---|---|---|
| Student → Career (`student_career`) | PARTIAL | CAP_CUR, CAP_INS, CAP_GRW |
| Fresher → Placement (`fresher_placement`) | SUPPORTED | CAP_CUR, CAP_INS, CAP_GRW |
| Professional → Progression (`professional_progression`) | PARTIAL | CAP_INS, CAP_GRW, CAP_MAS |
| Employee → Competency / EI (`employee_competency`) | SUPPORTED | CAP_CUR, CAP_INS, CAP_GRW |
| HR / Recruiter → Hire (`recruiter_hire`) | SUPPORTED | CAP_INS, CAP_GRW, CAP_MAS |
| Employer Org → Talent (`employer_talent`) | SUPPORTED | CAP_INS, CAP_GRW |
| Institute Admin → Cohort (`institute_cohort`) | SUPPORTED | CAP_INS, CAP_GRW |
