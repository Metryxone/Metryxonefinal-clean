...
|---|---|---|---|---|
| Student → Career (`student_career`) | PARTIAL | Career direction chosen / growth progressed; realized-outcome tail adoption-gated. | CAPADEX report (CapadexReportPhase); career builder surfaces. | Student dashboard; Career Builder. |
| Fresher → Placement (`fresher_placement`) | SUPPORTED | Application submitted / placed (placement outcome). | Career passport; launchpad readiness; placement surfaces. | Career Launchpad dashboard; campus placement explorer. |
| Professional → Progression (`professional_progression`) | PARTIAL | Role progression / promotion; adoption-gated outcome tail. | Progression / competency report; career passport. | Career Builder; competency intelligence. |
| Employee → Competency / EI (`employee_competency`) | SUPPORTED | Competency uplift; EI development; adoption-gated outcome tail. | Competency / EI report; competency intelligence dashboard. | Competency intelligence; EI health. |
| HR / Recruiter → Hire (`recruiter_hire`) | SUPPORTED | Hire decision / hired (hiring outcome). | Candidate fitment report; hiring intelligence. | Employer portal; hiring funnel; governance console. |
| Employer Org → Talent (`employer_talent`) | SUPPORTED | Talent pipeline built / roles filled (talent outcome). | Workforce OS; talent dashboards. | Employer portal; Workforce OS; governance console. |
| Institute Admin → Cohort (`institute_cohort`) | SUPPORTED | Cohort-level intervention / placement outcome. | Cohort analytics; placement reports (k-anon). | Unified institute dashboard; cohort analytics. |
