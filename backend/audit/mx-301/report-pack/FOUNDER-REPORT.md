...
- **Coverage** — the candidate has measurable input for that report. **16/16** are measured;
...
| Competency Radar | YES | 100% | Moderate | measured |
| Competency Heatmap | YES | 100% | Moderate | measured |
