...
export type ReportType = 'capadex' | 'career' | 'competency' | 'employability' | 'passport' | 'custom';
...
async function seedNarrativeBlocks(pool: Pool): Promise<void> {
  const blocks = [
    ...
    },
    {
      ...
      report_types: ['capadex','career','competency','employability'], tone: 'professional', category: 'footer',
    },
    {
