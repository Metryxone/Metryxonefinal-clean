...
import {
  ...
  Zap, Award, FileText, Route, Star, ArrowRight,
} from 'lucide-react';
...
export function useAdminDashboardState(onNavigate?: (screen: string) => void): AdminDashboardContextValue {
  ...
  const [activeTab, setActiveTab] = useState(() => {
    try { return localStorage.getItem('sa_active_tab') || 'overview'; } catch { return 'overview'; }
  });
  ...
  const [securityView, setSecurityView] = useState<'security' | 'audit'>('security');
  ...
  // =============================================================================
  // SIDEBAR NAVIGATION — Phase 0 S1 Reorganisation
  //
  // Classification key:
  //   CORE        — daily-use operational tabs (live data, CRUD, monitoring)
  //   OPERATIONAL — weekly-use config / reporting tabs
  //   LABS        — experimental / stub / research-stage (collapsed by default)
  //
  // Group → Classification
  //   (root)                    CORE     — Overview
  //   Frameworks                CORE     — LBI Framework, Competency, Reports
  //   CAPADEX Framework         CORE     — CAPADEX Framework (config), Users & Journeys, Analytics,
  //                                        Risk & Interventions, Upgrade Pricing, Reports,
  //                                        Signal Intelligence, CSI Profiles, Concern Engine, Ontology Matrix,
  //                                        Simulation & Validation, Bridge-Tag Coverage, Concern → Signal Map,
  //                                        Question Registry
  //   Behavioural Intelligence  CORE     — LBI Engine, Behavioural Signals, Predictive Intelligence, Multi-Tenant
  //   Assessment Config         OPERATIONAL — Question Bank, Custom Modules, Norms & Scoring
  //   Users & Orgs              CORE     — User Management (incl. Onboarding sub-tab),
  //                                        Parents, Students (18+), Institutions, HR & Jobs, Mentors
  //   Platform                  OPERATIONAL — Pricing & Packages, Learning Plans, Content Manager,
  //                                           Documents, Entity Codes, Consents, Access Control
  //   System                    OPERATIONAL — Financials, Security & Audit (merged), Notifications, Settings
  //   Advanced Labs             LABS     — BIOS Ultimate (×7), SPE (×4), BIOS Frontier (×4),
  //                                        ROIE (×4), PAIE (×4), LDE (×5), RIE (×6) = 34 tabs
  //
  // Merged tabs:
  ...
  // Sidebar menu items — 8 core groups + 1 collapsible Labs group (~35 core + 34 labs)
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'competency-fw', icon: Target,    label: 'Competency' },
        { id: 'reports',       icon: BarChart2, label: 'Reports' },
      ]
    },
    {
      label: 'CAPADEX Framework',
      items: [
        { id: 'capadex-fw',            icon: Sparkles,   label: 'CAPADEX Framework' },
        { id: 'capadex-users',         icon: Users,      label: 'Users & Journeys' },
        { id: 'capadex-analytics',     icon: BarChart3,  label: 'Analytics' },
        { id: 'capadex-interventions', icon: Shield,     label: 'Risk & Interventions' },
        { id: 'capadex-pricing',       icon: CreditCard, label: 'Upgrade Pricing' },
        { id: 'capadex-reports',       icon: BarChart2,  label: 'Reports' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'career-pathway-analytics',     icon: Route,     label: 'Pathway Analytics' },
        { id: 'occupation-analytics',         icon: Briefcase, label: 'Occupation Analytics' },
        { id: 'recommendation-analytics',     icon: Star,      label: 'Recommendation Analytics' },
        { id: 'forecast-analytics',           icon: TrendingUp, label: 'Forecast Analytics' },
        { id: 'transition-analytics',         icon: ArrowRight, label: 'Transition Analytics' },
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'talent-signal-master',          icon: Activity,      label: 'Signal Master (D3)' },
    ...
    },
    {
      ...
      items: [
        { id: 'talent-measurement-science',  icon: Calculator,  label: 'Scoring Formulas & Weights (D8)' },
    ...
    {
      label: 'Future Readiness Intelligence',
      items: [
    ...
    {
      label: 'Vision-X Intelligence',
      items: [
        { id: 'vx-capability-architecture',   icon: Layers,         label: 'Capability Architecture (D3)' },
        { id: 'vx-labor-market-intelligence',  icon: BarChart3,      label: 'Labor Market Intelligence (D15)' },
        { id: 'vx-evidence-intelligence',      icon: Shield,         label: 'Evidence Intelligence (D16)' },
        { id: 'vx-tenant-configuration',       icon: Building2,      label: 'Tenant Configuration (D0)' },
        { id: 'vx-assessment-runtime',         icon: ClipboardCheck, label: 'Assessment Runtime Extended (D7A)' },
        { id: 'vx-competency-science-council', icon: FlaskConical,   label: 'Competency Science Council (D25)' },
        { id: 'vx-workforce-knowledge-graph',  icon: GitBranch,      label: 'Workforce Knowledge Graph (D1)' },
        { id: 'vx-irt-engine',                 icon: Scale,          label: 'IRT & Adaptive Engine (D9)' },
        { id: 'vx-report-intelligence',        icon: FileText,       label: 'Report Intelligence (D21)' },
      ]
    },
    {
      label: 'Report Factory',
      items: [
        { id: 'report-factory-admin', icon: FileText, label: 'Design Report Factory' },
      ]
    },
    {
      label: 'Enterprise Analytics',
      items: [
        { id: 'enterprise-analytics', icon: BarChart3, label: 'Analytics Warehouse' },
      ]
    },
    {
      label: 'AI Governance',
    ...
    {
      label: 'Employability Intelligence',
      items: [
    ...
    },
    {
      label: 'Users & Orgs',
      items: [
        { id: 'usermgmt',     icon: Users,         label: 'User Management' }, // includes Onboarding sub-tab
    ...
    // ── Advanced Labs — experimental / stub — collapsed by default ────────────
    // Tabs here are research-stage. Toggle with the accordion header.
    {
      label: 'Advanced Labs',
      isLabs: true,
      items: [
        ...
        { id: 'rie-escalations',        icon: AlertTriangle, label: 'RIE: Escalations', badge: crisisPending, badgeColor: '#DC2626' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'ont-role-families',   icon: Users2,         label: 'Role Families' },
    ...
    },
    {
      ...
      items: [
        { id: 'caf-question-bank',       icon: Database,       label: 'Question Bank' },
        ...
        { id: 'caf-sessions',            icon: Timer,          label: 'Sessions' },
        { id: 'caf-scoring',             icon: ClipboardCheck, label: 'Scoring Engine' },
        { id: 'caf-analytics',           icon: LineChart,      label: 'Analytics' },
      ]
    },
  ]
    .map(group =>
