                ...
                <div key={`tier-${tierLabel}`} className="mt-3">
                  {!sidebarCollapsed && (
                    ...
                    >
                      ...
                      <span className="text-[13px] font-semibold capitalize flex-1 text-left">{tierLabel}</span>
                      {tierBadge > 0 && (
            ...
            return (
              <div key={group.label} className={gi > 0 ? 'mt-3' : ''}>
                {!sidebarCollapsed && (
                  ...
                  >
                    <span className="text-[13px] font-semibold capitalize flex-1 text-left select-none">{group.label}</span>
                    {!searching && (
                      <>
                        <span className="text-[10px] text-white/25">{group.items.length}</span>
            ...
            <div className="mt-3">
              {!sidebarCollapsed ? (
                <button
                  ...
                  className="w-full flex items-center gap-2 px-3 mb-1 py-1.5 rounded-lg text-white/70 hover:text-white hover:bg-white/5 transition-all"
                >
                  <span className="text-[13px] font-semibold capitalize flex-1 text-left select-none">Platform Access</span>
