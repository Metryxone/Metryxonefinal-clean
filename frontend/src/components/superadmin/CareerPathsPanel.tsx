  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-3">
        ...
        <Button variant="outline" size="icon" aria-label="Refresh" onClick={() => qc.invalidateQueries({ queryKey: ['/api/ontology/career-paths'] })}><RefreshCw className="h-4 w-4" /></Button>
      </div>
