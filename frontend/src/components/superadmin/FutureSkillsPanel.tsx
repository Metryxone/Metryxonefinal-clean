  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-3 flex-wrap">
        ...
        <Button variant="outline" size="icon" aria-label="Refresh" onClick={() => qc.invalidateQueries({ queryKey: ['/api/ontology/future-skills'] })}><RefreshCw className="h-4 w-4" /></Button>
      </div>
