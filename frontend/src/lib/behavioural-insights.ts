...
export const SUB_PERSONA_QUESTION_BANKS: Record<string, Question[]> = {
  ...
  // ── Enterprise personas (legacyKey 'professional' → prefix "I") — G-F1 ──────
  people_manager: [
    { id: 1, text: "delegate work and trust my team rather than holding on to critical tasks myself.", domain: "responsibility", domainLabel: "Delegation & Trust", tip: "Delegation is the first multiplier of a manager's impact." },
    { id: 2, text: "give direct, constructive feedback even when the conversation is uncomfortable.", domain: "communication", domainLabel: "Constructive Feedback", tip: "Timely candid feedback is the manager skill teams value most." },
    { id: 3, text: "stay composed and fair when managing conflict between team members.", domain: "stress", domainLabel: "Conflict Composure", tip: "Composure under conflict protects both outcomes and relationships." },
    { id: 4, text: "adapt my management style to different people and situations.", domain: "adaptability", domainLabel: "Adaptive Leadership", tip: "One style rarely fits every report — situational leadership scales." },
    { id: 5, text: "make timely decisions for my team even with incomplete information.", domain: "ambiguity_tolerance", domainLabel: "Decisive Judgement", tip: "Teams stall when managers wait for perfect certainty." },
    { id: 6, text: "reflect on my own impact as a manager and adjust how I lead.", domain: "reflection", domainLabel: "Leadership Reflection", tip: "Self-aware managers improve faster than experienced ones who don't reflect." },
    { id: 7, text: "keep my team motivated and engaged through changing priorities.", domain: "motivation", domainLabel: "Team Motivation", tip: "Sustaining engagement through change is core managerial work." },
    { id: 8, text: "set clear goals and expectations my team can actually act on.", domain: "goal_setting", domainLabel: "Goal Clarity", tip: "Ambiguous expectations are the hidden cause of most underperformance." },
    { id: 9, text: "take ownership when my team underperforms rather than assigning blame.", domain: "ownership", domainLabel: "Accountable Ownership", tip: "Owning team results builds the trust that turns performance around." },
    { id: 10, text: "build enough trust that people raise problems with me early.", domain: "social", domainLabel: "Psychological Safety", tip: "Early problem-surfacing is the dividend of psychological safety." },
  ],
  senior_leadership: [
    { id: 1, text: "set and communicate a clear long-term vision across the organisation.", domain: "communication", domainLabel: "Vision Setting", tip: "A vision only works once it is communicated until it is understood." },
    { id: 2, text: "make high-stakes decisions under uncertainty and own the consequences.", domain: "ambiguity_tolerance", domainLabel: "Strategic Judgement", tip: "Senior decisions are judged on conviction under ambiguity, not hindsight." },
    { id: 3, text: "stay composed and steady when leading through a crisis.", domain: "stress", domainLabel: "Crisis Composure", tip: "An organisation borrows its leaders' calm in a crisis." },
    { id: 4, text: "align competing priorities and stakeholders toward a shared goal.", domain: "social", domainLabel: "Stakeholder Alignment", tip: "Alignment, not authority, is what moves large organisations." },
    { id: 5, text: "adapt strategy as market and organisational conditions shift.", domain: "adaptability", domainLabel: "Strategic Adaptability", tip: "Strategy that can't adapt becomes the next constraint." },
    { id: 6, text: "develop other leaders rather than concentrating decisions in myself.", domain: "responsibility", domainLabel: "Leader Development", tip: "Building leaders is the highest-leverage thing a leader does." },
    { id: 7, text: "consider the systemic impact of my decisions, not just immediate results.", domain: "reflection", domainLabel: "Systems Reflection", tip: "Second-order effects separate seasoned leaders from reactive ones." },
    { id: 8, text: "sustain my own drive and resilience across long, demanding cycles.", domain: "resilience", domainLabel: "Executive Resilience", tip: "Durable energy is a leadership asset, not a personal afterthought." },
    { id: 9, text: "set ambitious yet credible organisational goals.", domain: "goal_setting", domainLabel: "Ambitious Goal Setting", tip: "Goals must stretch belief without breaking credibility." },
    { id: 10, text: "take ownership of culture and outcomes at the organisational level.", domain: "ownership", domainLabel: "Organisational Ownership", tip: "Culture is shaped by what leaders own and tolerate." },
  ],
  learning_development: [
    { id: 1, text: "diagnose the real capability gaps behind a training request.", domain: "reflection", domainLabel: "Needs Diagnosis", tip: "Most training requests name a symptom, not the underlying gap." },
    { id: 2, text: "design learning experiences that change on-the-job behaviour, not just knowledge.", domain: "initiative", domainLabel: "Behaviour-Focused Design", tip: "Behaviour change, not content delivery, is the real L&D outcome." },
    { id: 3, text: "stay current with evolving skills and learning methods.", domain: "curiosity", domainLabel: "Learning Currency", tip: "L&D credibility erodes quickly without staying current." },
    { id: 4, text: "set clear learning objectives tied to business goals.", domain: "goal_setting", domainLabel: "Objective Setting", tip: "Objectives linked to business goals are what earn L&D its budget." },
    { id: 5, text: "adapt content and delivery to very different learner groups.", domain: "adaptability", domainLabel: "Audience Adaptability", tip: "One format rarely lands across diverse learner populations." },
    { id: 6, text: "influence stakeholders to invest in building capability.", domain: "communication", domainLabel: "Stakeholder Influence", tip: "L&D impact depends on persuading sponsors to commit." },
    { id: 7, text: "keep learners motivated and engaged through a programme.", domain: "motivation", domainLabel: "Learner Engagement", tip: "Engagement is the precondition for any learning transfer." },
    { id: 8, text: "manage multiple programmes and priorities without quality slipping.", domain: "self_management", domainLabel: "Programme Management", tip: "Quality at scale is an operational discipline, not just design skill." },
    { id: 9, text: "use feedback and data to iterate on my programmes.", domain: "feedback", domainLabel: "Evidence-Led Iteration", tip: "Programmes improve fastest when measured and revised, not repeated." },
    { id: 10, text: "take ownership of capability outcomes across the organisation.", domain: "ownership", domainLabel: "Capability Ownership", tip: "Owning outcomes, not activity, is what makes L&D strategic." },
  ],
  // ── Higher-education faculty (legacyKey 'teacher' → "My students…") — G-F2 ──
  higher_ed_faculty: [
    { id: 1, text: "can manage their own learning and deadlines without constant prompting.", domain: "self_management", domainLabel: "Self-Directed Learning", tip: "Self-regulation is the strongest predictor of success in higher education." },
    { id: 2, text: "engage critically with material rather than memorising for exams.", domain: "curiosity", domainLabel: "Critical Engagement", tip: "Critical engagement, not recall, is what higher education is meant to build." },
    { id: 3, text: "seek help or clarification when they are genuinely struggling.", domain: "initiative", domainLabel: "Help-Seeking", tip: "Early help-seeking prevents most avoidable academic failure." },
    { id: 4, text: "communicate their ideas clearly in writing and discussion.", domain: "communication", domainLabel: "Academic Communication", tip: "Clear expression is inseparable from clear thinking at this level." },
    { id: 5, text: "handle academic pressure and deadlines without burning out.", domain: "stress", domainLabel: "Pressure Management", tip: "Sustainable pace protects both wellbeing and results." },
    { id: 6, text: "act constructively on feedback to improve their work.", domain: "feedback", domainLabel: "Feedback Uptake", tip: "Feedback only helps the students who actually act on it." },
    { id: 7, text: "stay motivated through long or demanding courses.", domain: "motivation", domainLabel: "Sustained Motivation", tip: "Motivation across a full course matters more than initial enthusiasm." },
    { id: 8, text: "reflect honestly on their own strengths and gaps.", domain: "reflection", domainLabel: "Self-Reflection", tip: "Accurate self-assessment is a skill faculty can deliberately develop." },
    { id: 9, text: "adapt to new formats, tools and ways of learning.", domain: "adaptability", domainLabel: "Learning Adaptability", tip: "Adaptability future-proofs students beyond any single curriculum." },
    { id: 10, text: "take responsibility for their own academic progress.", domain: "responsibility", domainLabel: "Academic Ownership", tip: "Ownership is what carries students past the structure of a course." },
  ],
};
